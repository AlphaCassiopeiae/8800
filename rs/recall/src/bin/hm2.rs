...
fn setup_edge_detector<'a>(
    ...
    let prg = pio_asm!(
        ...
        "set pins, 1 [30]",
        "wait 0 gpio 29 [30]",        // Wait for PIN_4 (clock) to go high
    ...
    sm.set_pin_dirs(embassy_rp::pio::Direction::In, &[input_pin]);
...
async fn main(_spawner: Spawner) {
    ...
    let ack_pin = &common.make_pio_pin(p.PIN_30); // PIN_5 for acknowledgment
